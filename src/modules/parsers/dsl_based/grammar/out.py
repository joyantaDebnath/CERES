...
def Longlength(Begin):
    ...
    if FLAG_Typelonglength:
        FLAG_Longlengthvalues, SIZE_Longlengthvalues, VAL_Longlengthvalues, Begin = Longlengthvalues(VAL_Typelonglength, Begin)
...
def Longlengthvalues(VAL_Typelonglength, Begin):
    ...
    if FLAG_Bytee:
        FLAG_Longlengthvalues, SIZE_Longlengthvalues, VAL_Longlengthvalues, Begin = Longlengthvalues(VAL_Typelonglength - 1, Begin)
        if FLAG_Longlengthvalues:
    ...
    if FLAG_Typecheck:
        ...
        if FLAG_Length:
            ...
            if FLAG_Value:
                ...
                if not (VAL_Length == 1 and SIZE_Value == VAL_Length and endcheck([1])):
                    return False, 0, None, Temp
    ...
    if FLAG_Type:
        ...
        if FLAG_Length:
            ...
            if FLAG_Value:
                ...
                if not (SIZE_Value == VAL_Length and  (  ( VAL_Type == 5 and VAL_Length == 0 and  ( VAL_Signoid == 784439383290839892228 or VAL_Signoid == 784439383290839892229 or VAL_Signoid == 784439383290839892235 or VAL_Signoid == 784439383290839892238 or VAL_Signoid == 784439383290839892236 or VAL_Signoid == 784439383290839892237 or VAL_Signoid == 784439383290839892234 or VAL_Signoid == 784439383290839892226 or VAL_Signoid == 784439383290839892227 )  )  or  ( VAL_Signoid != 784439383290839892228 and VAL_Signoid != 784439383290839892229 and VAL_Signoid != 784439383290839892235 and VAL_Signoid != 784439383290839892238 and VAL_Signoid != 784439383290839892236 and VAL_Signoid != 784439383290839892237 and VAL_Signoid != 784439383290839892234 and VAL_Signoid != 784439383290839892226 and VAL_Signoid != 784439383290839892227 )  )  and endcheck([1])):
                    return False, 0, None, Temp
    ...
    if FLAG_Type:
        ...
        if FLAG_Length:
            ...
            if FLAG_Value:
                ...
                VAL_Signoid = getintvalue([VAL_Signoid])
                if not (SIZE_Value == VAL_Length and  (  ( VAL_Type == 5 and VAL_Length == 0 and VAL_Signoid == 784439383290839892225 )  or VAL_Signoid != 784439383290839892225 )  and endcheck([1])):
                    return False, 0, None, Temp
...
def Signalgopk(Begin):
    ...
    if FLAG_Typecheck:
        FLAG_Length, SIZE_Length, VAL_Length, Begin = Length(Begin)
        if FLAG_Length:
            FLAG_Fieldssignalgopk, SIZE_Fieldssignalgopk, VAL_Fieldssignalgopk, Begin = Fieldssignalgopk(VAL_Length, Begin)
...
def Extensionsseq(Begin):
    ...
    if FLAG_Typecheck:
        FLAG_Length, SIZE_Length, VAL_Length, Begin = Length(Begin)
        if FLAG_Length:
            FLAG_Fieldsextensionsseq, SIZE_Fieldsextensionsseq, VAL_Fieldsextensionsseq, Begin = Fieldsextensionsseq(VAL_Length, Begin)
...
def Fieldsextensionsseq(VAL_Length, Begin):
    ...
    if FLAG_Extension:
        FLAG_Fieldsextensionsseq, SIZE_Fieldsextensionsseq, VAL_Fieldsextensionsseq, Begin = Fieldsextensionsseq(VAL_Length - SIZE_Extension, Begin)
        if FLAG_Fieldsextensionsseq:
    ...
    if FLAG_Typecheck:
        ...
        if FLAG_Length:
            ...
            if FLAG_Extnidgen:
                ...
                if True:
                    FLAG_Extensionsoption, SIZE_Extensionsoption, VAL_Extensionsoption, Begin = Extensionsoption(VAL_Extnidgen, VAL_Critical, Begin)
...
def Extensionsoption(VAL_Extnidgen, VAL_Critical, Begin):
    ...
    if (getintvalue([VAL_Extnidgen]) == 5578019):
        FLAG_Fieldsextensionaki, SIZE_Fieldsextensionaki, VAL_Fieldsextensionaki, Begin = Fieldsextensionaki(VAL_Extnidgen, VAL_Critical, Begin)
    ...
    if (getintvalue([VAL_Extnidgen]) == 5577998):
        FLAG_Fieldsextensionski, SIZE_Fieldsextensionski, VAL_Fieldsextensionski, Begin = Fieldsextensionski(VAL_Extnidgen, VAL_Critical, Begin)
    ...
    if (getintvalue([VAL_Extnidgen]) == 5577999):
        FLAG_Fieldsextensionsku, SIZE_Fieldsextensionsku, VAL_Fieldsextensionsku, Begin = Fieldsextensionsku(VAL_Extnidgen, VAL_Critical, Begin)
    ...
    if (getintvalue([VAL_Extnidgen]) == 5578021):
        FLAG_Fieldsextensionseku, SIZE_Fieldsextensionseku, VAL_Fieldsextensionseku, Begin = Fieldsextensionseku(VAL_Extnidgen, VAL_Critical, Begin)
    ...
    if (getintvalue([VAL_Extnidgen]) == 5578003):
        FLAG_Fieldsextensionsbc, SIZE_Fieldsextensionsbc, VAL_Fieldsextensionsbc, Begin = Fieldsextensionsbc(VAL_Extnidgen, VAL_Critical, Begin)
    ...
    if (getintvalue([VAL_Extnidgen]) == 5578001):
        FLAG_Fieldsextensionssan, SIZE_Fieldsextensionssan, VAL_Fieldsextensionssan, Begin = Fieldsextensionssan(VAL_Extnidgen, VAL_Critical, Begin)
    ...
    if (getintvalue([VAL_Extnidgen]) == 5578002):
        FLAG_Fieldsextensionsian, SIZE_Fieldsextensionsian, VAL_Fieldsextensionsian, Begin = Fieldsextensionsian(VAL_Extnidgen, VAL_Critical, Begin)
    ...
    if (getintvalue([VAL_Extnidgen]) == 5578016):
        FLAG_Fieldsextensionscertpol, SIZE_Fieldsextensionscertpol, VAL_Fieldsextensionscertpol, Begin = Fieldsextensionscertpol(VAL_Extnidgen, VAL_Critical, Begin)
    ...
    if (getintvalue([VAL_Extnidgen]) == 5578015):
        FLAG_Fieldsextensionscrldist, SIZE_Fieldsextensionscrldist, VAL_Fieldsextensionscrldist, Begin = Fieldsextensionscrldist(VAL_Extnidgen, VAL_Critical, Begin)
    ...
    if (getintvalue([VAL_Extnidgen]) == 3100166514561974529):
        FLAG_Fieldsextensionsaia, SIZE_Fieldsextensionsaia, VAL_Fieldsextensionsaia, Begin = Fieldsextensionsaia(VAL_Extnidgen, VAL_Critical, Begin)
        if FLAG_Fieldsextensionsaia:
            SIZE_Extensionsoption = SIZE_Fieldsextensionsaia
            VAL_Extensionsoption = VAL_Fieldsextensionsaia
            return True, SIZE_Extensionsoption, VAL_Extensionsoption, Begin
    if (getintvalue([VAL_Extnidgen]) != 5578019 and getintvalue([VAL_Extnidgen]) != 5577998 and getintvalue([VAL_Extnidgen]) != 5577999 and getintvalue([VAL_Extnidgen]) != 5578021 and getintvalue([VAL_Extnidgen]) != 5578003 and getintvalue([VAL_Extnidgen]) != 5578001 and getintvalue([VAL_Extnidgen]) != 5578002 and getintvalue([VAL_Extnidgen]) != 5578016 and getintvalue([VAL_Extnidgen]) != 5578015 and getintvalue([VAL_Extnidgen]) != 3100166514561974529):
        FLAG_Fieldsextension, SIZE_Fieldsextension, VAL_Fieldsextension, Begin = Fieldsextension(VAL_Extnidgen, VAL_Critical, Begin)
...
def Authcertissuer(Begin):
    ...
    if FLAG_Typecheck:
        FLAG_Length, SIZE_Length, VAL_Length, Begin = Length(Begin)
        if FLAG_Length:
            FLAG_Fieldsauthcertissuer, SIZE_Fieldsauthcertissuer, VAL_Fieldsauthcertissuer, Begin = Fieldsauthcertissuer(Begin)
            if FLAG_Fieldsauthcertissuer:
                SIZE_Authcertissuer = SIZE_Typecheck + SIZE_Length + SIZE_Fieldsauthcertissuer
                VAL_Authcertissuer = VAL_Fieldsauthcertissuer
                if not (VAL_Length > 0 and SIZE_Fieldsauthcertissuer == VAL_Length and endcheck([1])):
                    return False, 0, None, Temp
                return True, SIZE_Authcertissuer, VAL_Authcertissuer, Begin
    return False, 0, None, Temp

def Fieldsauthcertissuer(Begin):
    Temp = Begin
    FLAG_Typecheck, SIZE_Typecheck, VAL_Typecheck, Begin = Typecheck(48, Begin)
    if FLAG_Typecheck:
        FLAG_Length, SIZE_Length, VAL_Length, Begin = Length(Begin)
        if FLAG_Length:
            ...
            if FLAG_Fieldsaltname:
                ...
                VAL_Fieldsauthcertissuer = splituple([VAL_Fieldsaltname])
                if not (VAL_Length > 0 and SIZE_Fieldsaltname == VAL_Length and endcheck([1])):
                    return False, 0, None, Temp
                return True, SIZE_Fieldsauthcertissuer, VAL_Fieldsauthcertissuer, Begin
    return False, 0, None, Temp
...
def Fieldskeyusage(Begin):
    ...
    if FLAG_Typecheck:
        FLAG_Length, SIZE_Length, VAL_Length, Begin = Length(Begin)
        if FLAG_Length:
            FLAG_Kubitswithpadding, SIZE_Kubitswithpadding, VAL_Kubitswithpadding, Begin = Kubitswithpadding(VAL_Length, Begin)
...
def Fieldsekuseq(VAL_Length, Begin):
    ...
    if FLAG_Keypurposeid:
        FLAG_Fieldsekuseq, SIZE_Fieldsekuseq, VAL_Fieldsekuseq, Begin = Fieldsekuseq(VAL_Length - SIZE_Keypurposeid, Begin)
        if FLAG_Fieldsekuseq:
...
def Fieldsaltname(VAL_Length, Begin):
    ...
    if FLAG_Generelname:
        FLAG_Fieldsaltname, SIZE_Fieldsaltname, VAL_Fieldsaltname, Begin = Fieldsaltname(VAL_Length - SIZE_Generelname, Begin)
        if FLAG_Fieldsaltname:
...
def Policyinfo(Begin):
    ...
    if FLAG_Typecheck:
        FLAG_Length, SIZE_Length, VAL_Length, Begin = Length(Begin)
        if FLAG_Length:
            FLAG_Fieldspolicyinfo, SIZE_Fieldspolicyinfo, VAL_Fieldspolicyinfo, Begin = Fieldspolicyinfo(VAL_Length, Begin)
...
def Certificatepolicy(Begin):
    ...
    if FLAG_Typecheck:
        FLAG_Length, SIZE_Length, VAL_Length, Begin = Length(Begin)
        if FLAG_Length:
            FLAG_Fieldscertificatepolicy, SIZE_Fieldscertificatepolicy, VAL_Fieldscertificatepolicy, Begin = Fieldscertificatepolicy(Begin)
...
def Fieldscrldist(Begin):
    ...
    if FLAG_Typecheck:
        FLAG_Length, SIZE_Length, VAL_Length, Begin = Length(Begin)
        if FLAG_Length:
            FLAG_Distributionpoints, SIZE_Distributionpoints, VAL_Distributionpoints, Begin = Distributionpoints(VAL_Length, Begin)
...
def Fieldsdistributionpoint(Begin):
    Temp = Begin
    FLAG_Distributionpointname, SIZE_Distributionpointname, VAL_Distributionpointname, Begin = Distributionpointname(Begin)
    if True:
...
def Distributionpoint(Begin):
    ...
    if FLAG_Typecheck:
        FLAG_Length, SIZE_Length, VAL_Length, Begin = Length(Begin)
        if FLAG_Length:
            FLAG_Fieldsdistributionpoint, SIZE_Fieldsdistributionpoint, VAL_Fieldsdistributionpoint, Begin = Fieldsdistributionpoint(Begin)
...
def Distributionpoints(VAL_Length, Begin):
    ...
    if FLAG_Distributionpoint:
        FLAG_Distributionpoints, SIZE_Distributionpoints, VAL_Distributionpoints, Begin = Distributionpoints(VAL_Length - SIZE_Distributionpoint, Begin)
        if FLAG_Distributionpoints:
...
def Fieldsaiaseq(VAL_Length, Begin):
    ...
    if FLAG_Accessdesc:
        FLAG_Fieldsaiaseq, SIZE_Fieldsaiaseq, VAL_Fieldsaiaseq, Begin = Fieldsaiaseq(VAL_Length - SIZE_Accessdesc, Begin)
    ...
    if FLAG_Type:
        ...
        if FLAG_Length:
            ...
            if FLAG_Fieldstime:
                ...
                if not (SIZE_Fieldstime == VAL_Length and  (  ( VAL_Type == 23 and VAL_Length == 13 )  or  ( VAL_Type == 24 and VAL_Length == 15 )  )  and endcheck([1])):
                    return False, 0, None, Temp
                                            ...
                                            if FLAG_Secone:
                                                ...
                                                if FLAG_Sectwo:
                                                    ...
                                                    if FLAG_90:
                                                        ...
                                                        if not (0 <= VAL_Year and VAL_Year <= 99 and 1 <= VAL_Mon and VAL_Mon <= 12 and 1 <= VAL_Day and VAL_Day <= 31 and 0 <= VAL_Hour and VAL_Hour <= 23 and 0 <= VAL_Min and VAL_Min <= 59 and 0 <= VAL_Sec and VAL_Sec <= 59 and endcheck([1])):
                                                            return False, 0, None, Temp
                                                    ...
                                                    if FLAG_Secone:
                                                        ...
                                                        if FLAG_Sectwo:
                                                            ...
                                                            if FLAG_90:
                                                                ...
                                                                if not (0 <= VAL_Year and VAL_Year <= 9999 and 1 <= VAL_Mon and VAL_Mon <= 12 and 1 <= VAL_Day and VAL_Day <= 31 and 0 <= VAL_Hour and VAL_Hour <= 23 and 0 <= VAL_Min and VAL_Min <= 59 and 0 <= VAL_Sec and VAL_Sec <= 59 and endcheck([1])):
                                                                    return False, 0, None, Temp
...
def Fieldssignalgopk(VAL_Length, Begin):
    ...
    FLAG_Signoid, SIZE_Signoid, VAL_Signoid, Begin = Signoid(Begin)
    if FLAG_Signoid:
        FLAG_Signparampk, SIZE_Signparampk, VAL_Signparampk, Begin = Signparampk(VAL_Signoid, VAL_Length - SIZE_Signoid, Begin)
        if FLAG_Signparampk:
